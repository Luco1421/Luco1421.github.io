window.jwplayer = function(t) {
    ...
    function f(t) {
        return s || (s = function(t) {
            var e, s = t.get("controls"),
                f = h(),
                p = function(t, e) {
                    var n = t.get("playlist");
                    if (Array.isArray(n) && n.length)
                        for (var u = Object(i.f)(t.get("item"), n.length), a = Object(i.c)(Object(r.a)(n[u]), t), c = 0; c < a.length; c++)
                            for (var s = a[c], l = t.getProviders(), f = 0; f < o.a.length; f++) {
                                var d = o.a[f];
                                if (l.providerSupports(d, s)) return "html5" === d.name
                            }
                    return !1
                }(t);
            return s && f && p ? (e = n.e(7).then(function(t) {
                n(37);
                var e = n(22).default;
                return a.a.controls = n(21).default, Object(u.a)(n(53).default), e
            }.bind(null, n)).catch(d(c.t + 105)), l.html5 = e, e) : s && p ? function() {
                var t = n.e(5).then(function(t) {
                    var e = n(22).default;
                    return a.a.controls = n(21).default, Object(u.a)(n(53).default), e
                }.bind(null, n)).catch(d(c.t + 104));
                return l.html5 = t, t
            }() : s && f ? n.e(6).then(function(t) {
                n(37);
                var e = n(22).default;
                return a.a.controls = n(21).default, e
            }.bind(null, n)).catch(d(c.t + 103)) : s ? n.e(4).then(function(t) {
                var e = n(22).default;
                return a.a.controls = n(21).default, e
            }.bind(null, n)).catch(d(c.t + 102)) : (h() ? n.e(9).then(function(t) {
                return n(37)
    ...
    var r = n(31),
        ...
        u = function() {
            return (Object(i.isFileProtocol)() ? "https:" : "") + "//ssl.p.jwpcdn.com/player/v/8.15.1/"
        },
        a = function(t) {
            var e = ("0" + t).split(/\W/),
                n = r.a.split(/\W/),
    ...
    function d(t, e, n) {
        var i = t.getProviders(),
            u = t.get("preload"),
            a = Object(r.j)({}, e);
        if (a.preload = o(e.preload, u), a.allSources = v(e, t), a.sources = g(a.allSources, i), a.sources.length) return a.file = a.sources[0].file, a.feedData = n,
            function(t) {
    ...
    var a = function(t, e, n) {
        ...
        this.getStatus = function() {
            ...
            var r = u[t];
            return 0 !== i ? r : (r && r.then(c).catch(a), i = 1, r = new Promise(function(r, i) {
                var o = (e ? function(t) {
                        var e = document.createElement("link");
            ...
            this.load = function(t, e, n, o) {
                return n && "object" == typeof n ? Promise.all(Object.keys(n).filter(function(t) {
                    ...
                    return e.setupPlugin(u).then(function(e) {
                        ...
                        return e.removePlugin(u), t.code ? t : new r.s(null, Object(i.b)(u), t)
                    })
                })) : Promise.resolve()
            }
        },
    ...
    e.b = function(t) {
        var e, n, u;
        try {
            var a = Object(r.a)(t || "", Object(o.a)("NDh2aU1Cb0NHRG5hcDFRZQ==")).split("/");
            if ("pro" === (e = a[0]) && (e = "premium"), Object(i.a)(e)("setup") || (e = "invalid"), a.length > 2) {
                n = a[1];
                var c = parseInt(a[2]);
                c > 0 && (u = new Date).setTime(c)
            }
        } catch (t) {
            e = "invalid"
        }
        ...
        var h = Object(r.j)({
            ...
            v = function(t, e) {
                return function(t, n) {
                    ...
                    !n && i.status >= 400 && i.status < 600 && (n = i.status), l(e, n ? u.o : u.r, n || 6, t)
                }
            }(0, h);
            ...
            p.onreadystatechange = function(t) {
                return function(e) {
                    ...
                    if (4 === n.readyState) {
                        ...
                        var a = n.status;
                        if (a >= 400) return void l(t, u.o, a < 600 ? a : 6);
                        if (200 === a) return function(t) {
                            return function(e) {
                                ...
                                if (clearTimeout(t.timeoutId), t.responseType) {
                                    ...
                                    if (t.requireValidXML) return void l(t, u.o, 602)
                                }
                                t.oncomplete(n)
                            }
                        }(t)(e);
                        0 === a && Object(o.isFileProtocol)() && !/^[a-z][a-z0-9+.-]*:/.test(t.url) && l(t, u.o, 7)
                    }
                }
    ...
    var r = "8.15.1+commercial_v8-15-1.400.commercial.22eba28.hlsjs.1fd238c.hlsjsprogressive.06278c3.jwplayer.98dfaff.dai.07e1a38.freewheel.af0c077.googima.3bea836.googimanvmp.6873d1e.headerbidding.c9c5d84.vast.12203f2.analytics.12eed63.gapro.141397a"
}, function(t, e, n) {
    "use strict";
    var r = n(0),
        i = n(18),
            ...
            var e = t.el,
                ...
                h = function(n) {
                    if (clearTimeout(r), t.el)
                        ...
                        }(t, n, o), o ? x(t, u.n, n) : (x(t, u.sb, n), "touchend" !== n.type || p || S(n))
                    }
                };
    ...
    e.a = function() {
        ...
        function n(e) {
            e instanceof s.s && !e.code && (e = new s.s(s.o, 0)), t.trigger(i.w, e)
        }
    ...
    function g(t, e) {
        var n = "file:" === window.location.protocol ? "https:" : "",
            r = {
                bidding: "//ssl.p.jwpcdn.com/player/plugins/bidding/v/0.3.10/bidding.js",
                jwpsrv: "//ssl.p.jwpcdn.com/player/v/8.15.1/jwpsrv.js",
                dai: "//ssl.p.jwpcdn.com/player/plugins/dai/v/0.4.13/dai.js",
                vast: "//ssl.p.jwpcdn.com/player/plugins/vast/v/8.7.17/vast.js",
                googima: e ? "//ssl.p.jwpcdn.com/player/v/8.15.1/googimanvmp.js" : "//ssl.p.jwpcdn.com/player/plugins/googima/v/8.7.17/googima.js",
    ...
    var b = function(t, e) {
            var i, f, b, y = Object(o.b)(t, e),
                j = y.key || window.jwplayer && window.jwplayer.key,
                w = new c.b(j),
                O = w.edition();
            ...
            if (y.flashplayer = function(t) {
                ...
                }(y), i = y.playlist, Object(r.x)(i) && i.indexOf("__CONTEXTUAL__") > -1 && (y.playlist = function(t, e) {
    ...
    function S(t) {
        ...
        return new Promise(function(n, r) {
            ...
            var o = new O.a;
            o.on(w.eb, function(e) {
                var r = e.playlist;
                delete e.playlist, T(t, r, e), n()
            }), o.on(w.w, function(e) {
                T(t, [], {}), r(Object(x.z)(e, x.u))
            }), o.load(e)
        })
    }
    ...
    var A = n(36),
        _ = function(t, e) {
            return /isAMP/.test(document.location.search) ? n.e(1).then(function(r) {
                var i = new(0, n(167).default)(e);
                return t.attributes.ampController = i, Promise.resolve()
            }.bind(null, n)).catch(Object(y.b)(x.t + 130)) : Promise.resolve()
        };

    function F(t) {
        return L(t) ? Promise.resolve() : S(t).then(function() {
            if (t.get("drm") || Object(A.b)(t.get("playlist"))) return Object(A.d)(t.get("edition"))
        }).then(function() {
            return S(e = t).then(function() {
                if (!E(e)) {
                    var t = Object(k.b)(e.get("playlist"), e);
                    ...
                    var n = e.getProviders(),
                        r = Object(k.f)(e.get("item"), t.length),
                        i = n.choose(t[r].sources[0]),
                        o = i.provider,
                        u = i.name;
                    return "function" == typeof o ? o : y.a.html5 && "html5" === u ? y.a.html5 : n.load(u).catch(function(t) {
                        throw Object(x.z)(t, x.v)
                    })
                }
            });
            var e
    ...
    function I(t, e) {
        var n = [M(t), _(t, e)];
        return L(t) || n.push(Promise.resolve()), Promise.all(n)
    }
    ...
    var N = function(t) {
            ...
            return "string" != typeof e || function(t) {
                ...
                return !1
            }(e) ? Promise.resolve() : new C.a(e, !0).load().catch(function(t) {
                return t
            })
        },
        R = function(t) {
            ...
            return !Object(P.h)(n) || Object(P.f)(u) ? Promise.resolve() : new Promise(function(i) {
                return Object(P.i)(r, n).then(function(n) {
                    ...
                    if (!E(t)) {
                        ...
                        e.localization = Object(P.a)(r, u), i()
                    }
                }).catch(function(t) {
                    i(t.code === x.g ? t : Object(x.z)(t, x.f))
                })
            })
        },
        D = function(t) {
            ...
            this.start = function(n) {
                var r = Object(j.a)(t, n),
                    i = Promise.all([Object(y.d)(t), r, F(t), I(t, n), N(t), R(t)]),
    ...
    Object(r.j)(Q.prototype, {
        getAllItems: function() {
            ...
            return this.items.reduce(function(e, n) {
                ...
                return r && (e[n] = "captions" !== n ? Object(q.serialize)(r) : JSON.parse(r)), e
            }, {})
        },
        track: function(t) {
            var e = this;
    ...
    var W = Q,
        ...
        Z = n(64),
        $ = n(35);
    n(71), n(72), n.d(e, "b", function() {
        return nt
    });
    var G = function(t) {
        this._events = {}, this.modelShim = new U.a, this.modelShim._qoeItem = new z.a, this.mediaShim = {}, this.setup = new D(this.modelShim), this.currentContainer = this.originalContainer = t, this.apiQueue = new i.a(this, ["load", "play", "pause", "seek", "stop", "playlistItem", "playlistNext", "playlistPrev", "next", "preload", "setConfig", "setCurrentAudioTrack", "setCurrentCaptions", "setCurrentQuality", "setFullscreen", "addButton", "removeButton", "castToggle", "setMute", "setVolume", "setPlaybackRate", "addCues", "setCues", "setPlaylistItem", "resize", "setCaptions", "setControls"], function() {
            return !0
        })
    };

    function tt(t, e) {
        e && e.code && (e.sourceError && console.error(e.sourceError), console.error(x.s.logMessage(e.code)))
    }

    function et(t) {
        t && t.code && console.warn(x.s.logMessage(t.code))
    }
    ...
    Object(r.j)(G.prototype, {
        ...
        init: function(t, e) {
            var n = this,
                i = this.modelShim,
                o = new W("jwplayer", ["volume", "mute", "captionLabel", "captions", "bandwidthEstimate", "bitrateSelection", "qualityLabel", "enableShortcuts"]),
                u = o && o.getAllItems();
            i.attributes = i.attributes || {}, Object(r.j)(this.mediaShim, X.a);
            var a = t,
                c = b(Object(r.j)({}, t), u);
            c.id = e.id, c.setupConfig = a, Object(r.j)(i.attributes, c, X.b), i.getProviders = function() {
                return new B.a(c)
            }, i.setProvider = function() {};
            var s = Object(K.b)();
            i.get("backgroundLoading") || (s = Object(Z.a)(s.getPrimedElement(), s));
            var l = new $.a(Object($.b)(this.originalContainer)).once("gesture", function() {
                s.prime(), n.preload(), l.destroy()
            });
            return i.on("change:errorEvent", tt), this.setup.start(e).then(function(t) {
                var u = t.core;
                if (!u) throw Object(x.z)(null, x.w);
                if (n.setup) {
                    n.on(w.ub, et), t.warnings.forEach(function(t) {
                        n.trigger(w.ub, t)
                    });
                    ...
                    var l = n._model;
                    return i.off("change:errorEvent", tt), l.on("change:errorEvent", tt), o.track(l), n.updatePlaylist(l.get("playlist"), l.get("feedData")).catch(function(t) {
                        throw Object(x.z)(t, x.u)
                    })
                }
            }).then(function() {
                ...
                n.setup && function(t, e, n) {
                    Promise.resolve().then(function() {
                        var r = Object(x.A)(x.r, x.y, n),
                            i = t._model || t.modelShim;
                        r.message = r.message || i.get("localization").errors[r.key], delete r.key;
                        var o = i.get("contextual");
                        if (!o) {
                            var u = Object(J.a)(t, r);
                            J.a.cloneIcon && u.querySelector(".jw-icon").appendChild(J.a.cloneIcon("error")), nt(t, u)
                        }
                        i.set("errorEvent", r), i.set("state", w.mb), t.trigger(w.jb, r), o && e.remove()
                    })
                }(n, e, t)
            })
        },
        playerDestroy: function() {
            this.apiQueue && this.apiQueue.destroy(), this.setup && this.setup.destroy(), this.currentContainer !== this.originalContainer && nt(this, this.originalContainer), this.off(), this._events = this._model = this.modelShim = this.apiQueue = this.setup = null
        },
            ...
            "function" == typeof n[o] && "Events" !== o ? t[o] = function t(e, n, r, i, o) {
                return function() {
                    ...
                    if ("free" === (o.edition || function(t, e, n) {
                        ...
                        if (["addButton", "addCues", "detachMedia", "load", "next", "pause", "play", "playlistItem", "playlistNext", "playlistPrev", "playToggle", "resize", "seek", "setCaptions", "setConfig", "setControls", "setCues", "setFullscreen", "setMute", "setPlaybackRate", "setPlaylistItem", "setVolume", "stop"].indexOf(r) > -1) return K(r), e;
                        if (["createInstream", "setCurrentAudioTrack", "setCurrentCaptions", "setCurrentQuality"].indexOf(r) > -1) return K(r), null
                    }
                    if (l || c.push([r, a]), s) return Z(n, c), n[r].apply(e, u);
                    ! function(t, e) {
                        var n = {
    ...
    Object(r.j)(G, W), L(G), "function" == typeof $.define && $.define.amd && $.define([], function() {
        return G
    });
    var tt = G;
    $.jwplayer && (tt = $.jwplayer), e.default = tt
}]).default;
var jwDefaults = {
    aspectratio: "16:9",
    autostart: !1,
